...
const svgFeature = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 500" width="1024" height="500">
  ...
  <g transform="translate(130, 105) scale(12)">
    <path fill="#FFFFFF" d="M6,2v6h0.01L6,8.01 10,12l-4,4 0.01,0.01H6V22h12v-5.99h-0.01L18,16l-4,-4 4,-3.99 -0.01,-0.01H18V2H6zM16,16.5V20H8v-3.5l4,-4 4,4zM12,11l-4,-4V4h8v3.5l-4,4z" />
  </g>

  <text x="480" y="240" fill="#FFFFFF" font-family="sans-serif" font-weight="900" font-size="68">Focus Intent</text>
  <text x="480" y="310" fill="#80cbc4" font-family="sans-serif" font-weight="300" font-size="36">Stop Doomscrolling. Reclaim Your Time.</text>
</svg>`;

const resvgIcon = new Resvg(svgIcon, {
  fitTo: { mode: 'width', value: 512 },
});
const pngIconData = resvgIcon.render();
const pngIconBuffer = pngIconData.asPng();
fs.writeFileSync('play_store_icon.png', pngIconBuffer);

const resvgFeature = new Resvg(svgFeature, {
  fitTo: { mode: 'width', value: 1024 },
});
const pngFeatureData = resvgFeature.render();
const pngFeatureBuffer = pngFeatureData.asPng();
fs.writeFileSync('feature_graphic.png', pngFeatureBuffer);
