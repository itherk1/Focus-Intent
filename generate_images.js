...
fs.writeFileSync('play_store_icon.png', iconBuffer);
...
const featBuffer = featCanvas.toBuffer('image/png');
fs.writeFileSync('feature_graphic.png', featBuffer);

console.log('Successfully generated PNGs synchronously');
